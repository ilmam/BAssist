...
$entityNotes = [
    ...
    'business_objective_stakeholder_need' => 'M:N — Business Objective ↔ Stakeholder Need.',
...
$md[] = '  ├─ BusinessNeed ←M:N→ BusinessObjective ←M:N→ StakeholderNeed';
$md[] = '  │                                          ↑ M:N';
$md[] = '  │                                     Stakeholder';
...
$md[] = '**Business Need → Business Objective → Stakeholder Need → Functional Requirement / BDD Feature**.';
$md[] = '';
$md[] = '## Tables (domain)';
$md[] = '';
...
$erd[] = '| `business_objective_stakeholder_need` | business_objectives ↔ stakeholder_needs |';
