...
$erd[] = '    STATUSES ||--o{ BUSINESS_OBJECTIVES : status';
$erd[] = '    STATUSES ||--o{ BUSINESS_NEEDS : status';
$erd[] = '    STATUSES ||--o{ STAKEHOLDER_NEEDS : status';
$erd[] = '    STATUSES ||--o{ FEATURES : status';
$erd[] = '    PRIORITIES ||--o{ BUSINESS_OBJECTIVES : moscow';
$erd[] = '    PRIORITIES ||--o{ BUSINESS_NEEDS : moscow';
