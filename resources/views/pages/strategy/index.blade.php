    ...
    <div class="space-y-5">
        <x-card title="{{ __('ui.strategy') }}">
            ...
            <x-list-filter-panel
                ...
                :clear-url="! empty($filters['project_id']) ? route('strategy.index', array_filter(['workspace_id' => $filters['workspace_id'] ?? null, 'clear_project' => 1])) : null"
            >
                <form method="GET" action="{{ route('strategy.index') }}" class="list-filter-panel__form" data-list-filter-form>
