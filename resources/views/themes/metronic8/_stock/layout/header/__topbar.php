...
<div class="topbar d-flex align-items-stretch flex-shrink-0">
    ...
    <div class="d-flex align-items-center ms-3 ms-lg-5">
        <!--begin::Menu wrapper-->
        <div class="btn btn-icon btn-topbar w-30px h-30px w-md-40px h-md-40px position-relative" id="kt_drawer_chat_toggle">
...
<!--end::Svg Icon-->
            <span class="bullet bullet-dot bg-danger h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink">
            </span>
        </div>
        <!--end::Menu wrapper-->
    </div>
    ...
    <div class="d-flex align-items-center ms-3 ms-lg-5">
        <!--begin::Menu- wrapper-->
        <div class="btn btn-icon btn-topbar w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
